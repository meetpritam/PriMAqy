...
import { ExternalLink, Copy, Check, Terminal, Code2 } from 'lucide-react';
              ...
              >
                ...
                <div className="relative z-10 pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center font-medium transition-all duration-200 rounded-full bg-[#171717] text-white hover:bg-[#262626] text-sm px-5 py-2.5 min-h-[44px] h-11 gap-2 shadow-[0_2px_10px_rgba(0,0,0,0.12)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.20)]"
                  >
